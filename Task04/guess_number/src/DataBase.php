...
namespace ktkrst\guess_number\DataBase;

use SQLite3;

use function ktkrst\guess_number\View\showGamesInfo;
use function ktkrst\guess_number\View\showTurnInfo;
use function ktkrst\guess_number\View\showGamesTop;

function createDB()
{
    $dataBase = new \SQLite3('GuessNumber.db');
